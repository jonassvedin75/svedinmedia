...
// This page reuses the existing IdeaDetailPage logic but is now part of the (app) layout
// Original path: src/app/my-ideas/[id]/page.tsx
...
export default function IdeaDetailPage() {
  ...
  const createdAtDate = idea.createdAt instanceof Date ? idea.createdAt : new Date(idea.createdAt);
        ...
        <CardHeader>
          ...
          {idea.createdAt && (
            <CardDescription className="flex items-center gap-1 text-sm text-muted-foreground">
              <CalendarDays className="h-4 w-4" /> Sparad: {format(createdAtDate, "PPPPp", { locale: sv })}
            </CardDescription>
          )}
        </CardHeader>
        <CardContent>
